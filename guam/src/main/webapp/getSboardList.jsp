...
<body>
    <div>
    	<br><br><button id="toggleBtn">신청글 작성</button><br>
        <!-- 에디터를 적용할 요소 (컨테이너) -->
        <div id="toggleDiv" style="display: none">
        	...
        	<br><button id="cancelBtn" style="margin-left: 380px; ">취소하기</button><button id="submitButton" style="margin-left: 10px; ">신청하기</button>
		</div>
		
        <form id="myForm" action="insertSboard.do" method="post">
            <input name="cate" type="hidden" value="s" />
            <input name="writerid" type="hidden" value="${sessionScope.id}" />
            <input name="content" type="hidden" id="contentInput" />
        </form>
        
        
        <br><h2 style="margin-left: 80px; font-weight: bold">신청 글</h2>
